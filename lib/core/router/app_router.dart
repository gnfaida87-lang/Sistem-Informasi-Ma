...
class AppRoutes {
  ...
  static String dashboardForRole(String role, {bool isWaliKelas = false}) {
    switch (role.toLowerCase()) {
      ...
      case 'kepala':
      case 'kepala_madrasah': return kepala;
      case 'wakakur':
      case 'wakil_kurikulum': return wakakur;
      case 'operator':
      case 'operator_data': return operator_;
      case 'keuangan':
      case 'admin_keuangan': return keuangan;
      case 'guru':
      case 'guru_mapel': return isWaliKelas ? guruWaliKelas : guru;
      case 'bimbel':
      case 'guru_bimbel': return bimbel;
      case 'orang_tua':
      case 'parent': return orangTua;
